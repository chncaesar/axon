...
class Prompt(BaseModel):
    """Handles loading and retrieving prompts.
    ...
    def load_prompts(self) -> Self:
        ...
        Returns:
            The prompt instance with loaded prompts.
        ...
        try:
            if self.prompt_file:
                ...
                prompts_path = os.path.join(dir_path, "../prompt.json")
...
def get_prompt(prompt_file: str | None = None) -> Prompt:
    """Get a cached prompt instance.

    This function caches prompt instances to avoid redundant file I/O and JSON parsing.
    ...
    """
    return Prompt(prompt_file=prompt_file)
